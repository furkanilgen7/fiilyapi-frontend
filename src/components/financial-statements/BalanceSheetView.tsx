 ...
 *
 * Mockup'ın üst barı (BL:14-22) BASILMAZ: kabuk canon'udur. Sol menü (BL:24-31)
 * `FinancialStatementsSidebar` olarak BU bileşenin içinde basılır — rota
 * grubunda BİLEREK `layout.tsx` YOKTUR, çünkü kök `/mali-tablolar` ekranı (E11)
 * drill sidebar ÇİZMEZ.
 *
    ...
    <>
      ...
      <div className="fs mali-tablolar-content">
        ...
        <p className="fs__eyebrow">
          <Link href={FINANCIAL_STATEMENTS_URL} className="fs__back" data-testid="bl-back">
            ← Mali Tablolar
          </Link>
        </p>
  ...
  return (
    <>
      ...
      <div className="fs-sides">
        {/* BL:44-63 */}
        <BalanceSheetSideCard side={data.assets} tone="assets" testId="bl-assets" />
        {/* BL:66-88 */}
